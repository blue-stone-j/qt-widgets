...
void uiTEST_MainWindow::initDockWidget()
{
  ...
  tItem->setText(0, "SEGY");
  tItem->setIcon(0, tIcon0);
  tTree->addTopLevelItem(tItem);
  tItem->setData(0, 3, TREE_DATA_SEGY);
  QTreeWidgetItem *tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "地震体数据.segy");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "均方根振幅.segy");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  ...
  tItem->setIcon(0, tIcon0);
  tTree->addTopLevelItem(tItem);
  tItem->setData(0, 3, TREE_DATA_HOR);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "T74.dat");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem->setExpanded(true);
  ...
  tItem->setIcon(0, tIcon0);
  tTree->addTopLevelItem(tItem);
  tItem->setData(0, 3, TREE_DATA_SAMPLEWELL);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-1");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-2");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-3");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-4");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-5");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-6");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-7");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-8");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem1 = new QTreeWidgetItem();
  tItem1->setText(0, "JH-9");
  tItem1->setIcon(0, tIcon1);
  tItem->addChild(tItem1);
  tItem->setExpanded(true);
...
{
  QString layoutFile = "../userdata/msqcMain.layout.dat";
  if (isSave)
  {
